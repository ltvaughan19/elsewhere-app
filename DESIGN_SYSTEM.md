...
## Archive — Atlas Calm (do not extend)

**Feel (old):** Trusted relocation command center × premium travel editorial  

### Old color sketch (retired as defaults)

Navy / sand / jungle / ivory / gold / ocean — see git history for full tokens.

New defaults: `--bg: #07090d`, `--fg: #f4f1ea`, `--accent: #c8b48a`, `--accent-2: #7eb8c9` (Instrument Serif + Outfit).
